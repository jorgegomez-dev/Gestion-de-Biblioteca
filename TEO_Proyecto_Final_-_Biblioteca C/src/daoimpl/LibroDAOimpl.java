...
/*    Usamos LibroDAOimpl para separar la capa de datos de la capa de logica de negocio
      Aqui colocaremos todos los servicios que nos brinda la clase Libro, implementando la interface LibroDAO 
      y aqui crearemos un Array dinamico para el almacenamiento de los libros que tiene la biblioteca (ya que 
      no trabajaremos con base de datos). 
      Si trabajasemos con bases de datos, creariamos una clase del tipo Conecction importando la libreria JDBC.
 */
...
public class LibroDAOimpl implements LibroDAO{
    ...
    public void busquedaPorApellidoAutor(List<Libro> libros, String apellido) {
        ...
        if (band != true) {
            System.out.println("No se encuentra el Libro. Verifique Apellido del Autor");
        }
        System.out.println("---------------------------");
    }
